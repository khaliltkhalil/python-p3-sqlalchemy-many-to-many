...
Revision ID: afeffccf583e
Revises: a28af33e6866
Create Date: 2023-08-05 20:12:22.432696
...
def upgrade() -> None:
    ...
    sa.Column('createed_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
